...
public static class PermissionCodes
{
    ...
    public const string CardRegister = "Card.Register";
    ...
    public const string BusView   = "Bus.View";
    public const string BusCreate = "Bus.Create";
    public const string BusUpdate = "Bus.Update";
    public const string BusDelete = "Bus.Delete";

    public const string TerminalView   = "Terminal.View";
    public const string TerminalCreate = "Terminal.Create";
    public const string TerminalUpdate = "Terminal.Update";
    public const string TerminalDelete = "Terminal.Delete";
